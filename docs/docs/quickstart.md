...
This is the fastest way to understand the Vordr deployment model.

## Hosted model

In the hosted model, Vordr runs the control plane and you install lightweight agents on the infrastructure you want monitored.

Typical flow:

1. Create an Vordr account
...
If you are evaluating Vordr for a serious buyer demo, verify these pieces first:
