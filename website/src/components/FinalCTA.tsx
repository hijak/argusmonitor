  ...
  <section className="relative overflow-hidden border-t border-border py-20 lg:py-28">
    ...
    <div className="container relative mx-auto px-4 lg:px-8">
      <div className="mx-auto max-w-2xl space-y-6 text-center">
        <h2 className="text-3xl font-display font-bold text-foreground sm:text-4xl">Ready to monitor without the bloat?</h2>
        <p className="text-lg text-muted-foreground">
          Deploy in minutes. Run it yourself or use a hosted control plane. Browse the plugin directory for official collectors and UI integrations,
          then send PRs for new ones.
        </p>
